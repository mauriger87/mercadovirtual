...
// 🚧 Cálculo automático de envío por dirección — PAUSADO TEMPORALMENTE
// (algunas direcciones de Mendoza no las encuentra el servicio de geocodificación)
// Para reactivarlo, poner en `true`.
const ENVIO_AUTOMATICO_ACTIVO = false;
...
function abrirCobertura() {
    if (!ENVIO_AUTOMATICO_ACTIVO) {
        toast('🚧 Por ahora el costo de envío se confirma por WhatsApp. Escribí tu dirección al hacer el pedido.', 'warning');
        return;
    }
