...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 🚧 Si el cálculo automático de envío está pausado, ignorar cualquier
    // envío calculado que haya quedado guardado de una sesión anterior.
    if (typeof ENVIO_AUTOMATICO_ACTIVO !== 'undefined' && !ENVIO_AUTOMATICO_ACTIVO && envioCliente.calculado) {
    ...
    // Siempre se sincroniza en segundo plano: el usuario ve el catálogo
    // guardado al instante (localStorage) y se actualiza solo si hay cambios,
    // sin pantalla de carga. Evita mostrar precios/stock viejos por horas.
